...
- Soapbox requests include Soapbox Option, service model, and tier in `Description`. Soapbox requests with Service Model `Basic3PL` use the Basic3PL uplift tier list and store that selection in `b3pl_tier`.
